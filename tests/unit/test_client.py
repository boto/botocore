...
class TestAutoGeneratedClient(unittest.TestCase):
    ...
    def test_client_makes_call_with_error(self):
        error_responses = [
            ...
            {'Error': {'Code': 'InvalidAddress.NotFound', 'Message': ''}},
            {'Error': {'Code': 'TestOperationException', 'Message': ''}},
        ...
        for error_response in error_responses:
            ...
            code = error_response["Error"].get("Code", "ClientError")
            code_id = code.replace(".", "").replace("404", "ClientError404")
            if code_id == "TestOperationException":
                self.assertIsInstance(e.exception, service_client.meta.exceptions.TestOperationException)
