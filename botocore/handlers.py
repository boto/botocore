...
BUILTIN_HANDLERS = [
    ...
    ('getattr.codedeploy.list_git_hub_account_token_names',
     ClientMethodAlias('list_github_account_token_names')),
    ('getattr.codedeploy.delete_git_hub_account_token',
     ClientMethodAlias('delete_github_account_token')),
