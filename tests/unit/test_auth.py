...
from botocore.auth import AUTH_TYPE_MAPS, AUTH_TYPE_TO_SIGNATURE_VERSION, BaseSigner, resolve_auth_type
from tests import mock


#TODO probably put this test in a class
def test_auth_resolves_first_available():
    ...
    with mock.patch('botocore.auth.AUTH_TYPE_MAPS', auth_types):
        with mock.patch('botocore.auth.AUTH_TYPE_TO_SIGNATURE_VERSION', auth_type_conversions):
