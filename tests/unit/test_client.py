...
class TestAutoGeneratedClient(unittest.TestCase):
    ...
    def test_service_emits_data_loaded_event(self):
        event_emitter = mock.Mock()
        creator = self.create_client_creator(event_emitter=event_emitter)
        creator.create_client('myservice', 'us-west-2')
        event_emitter.emit.assert_any_call(
            'service-data-loaded.myservice',
            service_name='myservice', service_data=mock.ANY,
            data_loader=mock.ANY, event_emitter=event_emitter
        )
