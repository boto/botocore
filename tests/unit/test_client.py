...
class TestAutoGeneratedClient(unittest.TestCase):
    ...
    def create_client_creator(self, endpoint_creator=None, event_emitter=None,
        ...
        endpoint_creator.resolver.construct_endpoint.return_value = {}
    ...
    def test_events_are_per_client(self):
        ...
        first_client = creator.create_client('myservice', 'us-west-2')
        second_client = creator.create_client('myservice', 'us-west-2')
